...
def analyze_resume_and_job(resume, job_description):
    ...
    1. A tailored header for the resume, including your name and key contact information.
    2. A custom summary (3-4 sentences) that highlights your most relevant skills and experiences for this specific job.
    3. A detailed two-column comparison of your skills and the job requirements, listing at least 7 key points for each. Ensure your skills comparison is comparable to Job Requirements, and write your skills in a sentence to best match Job Requirements statements. Include the company name from the job description before "Job Requirements".
    4. Extract and summarize your education information.
    5. Extract and summarize at least three relevant work experiences for this job, focusing on your most recent or most applicable positions. Each experience should be described in detail.
    6. Extract your full name, address, email, and phone number for use in a cover letter.
    7. Extract the company name from the job description for use in the cover letter greeting.

    **All responses should be written in the first person.**
    """
...
def generate_cover_letter(resume, job_description, cover_letter_info):
    ...
    system_message = """
    You are an expert cover letter writer with years of experience in HR and recruitment. Your task is to create a compelling, personalized cover letter based on your resume, the job description provided, and the specific candidate information given. The cover letter should:
    1. Highlight your most relevant skills and experiences for the specific job
    2. Show enthusiasm for the position and company
    3. Be concise, typically not exceeding one page
    4. Encourage the employer to review the attached resume and consider you for an interview
