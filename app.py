    ...
    if resume and job_description:
        try:
            with st.spinner("Analyzing and tailoring your resume..."):
                ...
                # Format the comparison section as two columns
                skills, requirements = comparison
                comparison_formatted = "Skills & Experience | Job Requirements\n"
                comparison_formatted += "--------------------|------------------\n"
                for skill, req in zip(skills, requirements):
                    comparison_formatted += f"{skill} | {req}\n"
...
if st.session_state.generated:
    ...
    create_pdf(data['full_resume'], "tailored_resume.pdf")
    create_pdf(data['cover_letter'], "cover_letter.pdf")
